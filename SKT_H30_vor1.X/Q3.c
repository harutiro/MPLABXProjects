        ...
        if(SW1 == UP && SW2 ==DN){
            ...
            while (SW1 ==DN &&SW2 ==DN){
                for(i = 1;i<=6;i++){
                    ...
                    if(zyoutai == 1){
                        switch(i){
                            case 1:  motor(360*i,num0[i],num0[i],T2,L);
                                break;
                            case 2:  motor(360*i,num0[i],num0[i],H2,L);
                                break;
                            case 3:  motor(360*i,num0[i],num0[i],T2,L);
                                break;
                            case 4:  motor(360*i,num0[i],num0[i],H2,H);
                                break;
                            case 5:  motor(360*i,num0[i],num0[i],T2,H);
                                break;
                            case 6:  motor(360*i,num0[i],num0[i],H2,H);
                                break;
                        }
                        ...
                        while(1){
                            if(SW1 == DN && SW2 == DN){
                                if(i>=3){
                                    LEDB = ON;
                                    zyoutai = waitSEGStop(SEGg,SEGg,500,0b001);
                                    if(zyoutai == 1){
                                        zenoff();
                                        goto hukki;
                                    }
