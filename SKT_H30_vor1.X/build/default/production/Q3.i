...
# 579 "Q3.c"
    ...
    while(1){
        ...
        if(RA0 == 0 && RA1 ==1){
            ...
            while (RA0 ==1 &&RA1 ==1){
                for(i = 1;i<=6;i++){
                    zyoutai = waitSEGStop(num0[i],num0[i],1000,0b001);
                    ...
                    if(zyoutai == 1){
                        switch(i){
                            case 1: motor(360*i,num0[i],num0[i],1,5);
                                break;
                            case 2: motor(360*i,num0[i],num0[i],2,5);
                                break;
                            case 3: motor(360*i,num0[i],num0[i],1,5);
                                break;
                            case 4: motor(360*i,num0[i],num0[i],2,1);
                                break;
                            case 5: motor(360*i,num0[i],num0[i],1,1);
                                break;
                            case 6: motor(360*i,num0[i],num0[i],2,1);
                                break;
                        }
                        ...
                        while(1){
                            if(RA0 == 1 && RA1 == 1){
                                if(i>=3){
                                    RC1 = 0;
                                    zyoutai = waitSEGStop(0x40,0x40,500,0b001);
                                    if(zyoutai == 1){
                                        zenoff();
                                        goto hukki;
                                    }
