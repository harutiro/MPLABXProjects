        ...
        if(count <= 150 && RA2 == 1){
            ...
            while(1){
                ...
                if(((flag_sw3==0)&&(flag_P==1))){
                    ...
                    if(segL == 0){
                        segL = (0x01|0x02|0x04|0x08|0x10|0x40);
                    }else if(segL == (0x01|0x02|0x04|0x08|0x10|0x40)){
                        segL = (0x04|0x08|0x10|0x20|0x40);
                    }else if(segL ==(0x04|0x08|0x10|0x20|0x40)){
                        segL = (0x08|0x10|0x40);
                    }else if(segL == (0x08|0x10|0x40)){
                        segL =(0x01|0x02|0x04|0x08|0x10|0x40);
                    }
