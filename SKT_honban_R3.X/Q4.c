...
//}
//
//unsigned short dnRoop[]={SEGg,SEGc,SEGd,SEGe};
//unsigned short upRoop[]={SEGg,SEGb,SEGa,SEGf};
//
//
//
///*  メイン関数（問題にあわせて変更）    */
...
//        }
//        
//        if(SW1 == DN && SW2 == UP && segL != 0 && segR != 0){
//            
//            if(segL == SEGA && segR == SEGL){
//                for(j= 0;j<=2;j++){
//                    for(i = 0; i<=3;i++){
//                        motor(30,SEGA,dnRoop[i],T2,L);
//
//                        if(LEDR == ON){
//                            LEDR = OFF;
//                        }else if(LEDR == OFF){
...
//            }
//            
//            if(segL == SEGA && segR == SEGH){
//                for(j= 0;j<=5;j++){
//                    for(i = 0; i<=3;i++){
//                        motor(30,SEGA,upRoop[i],H2,H);
//
//                        if(LEDB == ON){
//                            LEDB = OFF;
//                        }else{
...
//            }
//
//            if(segL == SEGB && segR == SEGL){
//                motor(180,SEGB,SEGa|SEGb|SEGc|SEGd,T2,L);
//                waitSEG(SEGB,SEGd,1000);
//                motor(180,SEGB,SEGa,H2,H);
//
//                zenoff();
//                while(1){
//                    dynam(SEGB,SEGg,0,0);
...
//            }
//
//            if(segL == SEGB && segR == SEGH){
//                motor(180,SEGB,SEGa|SEGf|SEGe|SEGd,H2,H);
//                waitSEG(SEGB,SEGd,1000);
//                motor(180,SEGB,SEGa,T2,L);
//
//                zenoff();
//                while(1){
//                    dynam(SEGB,SEGg,0,0);
