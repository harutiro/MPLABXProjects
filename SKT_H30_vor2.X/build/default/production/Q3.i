...
# 800 "Q3.c"
    ...
    while(1){
        ...
        if(RA0 == 1 && RA1 ==1){
            waitSEG((0x02|0x04|0x08|0x10|0x20),(0x01|0x02|0x10|0x20|0x40),3000);
            while(1){
