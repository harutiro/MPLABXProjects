...
# 579 "Q4.c"
    ...
    while(1){
        ...
        if(RA0 == 0 && RA1 ==0){
            ...
            if(zyoutai == 1){
                motor(90,num0[0],num0[0],1,1);
                motor(90,num0[9],num0[0],1,1);
            ...
            if(zyoutai == 1){
                motor(90,num0[0],num0[0],1,1);
                motor(90,num0[9],num0[0],1,1);
                motor(90,num0[1],num0[8],1,1);
                motor(90,num0[2],num0[7],1,1);
        ...
        if(RA0 == 0 && RA1 == 1){
            zyoutai = motorStop(180,num0[1],num0[8],1,5,0b001);
            if(zyoutai != 0){
                motor(zyoutai,0,0,1,5);
                motor(180,0,0,2,1);
                while(1){
                    dynam(num0[1],num0[8],0,0);
            ...
            zyoutai = motorStop(180,num0[3],num0[6],1,5,0b001);
            if(zyoutai != 0){
                motor(zyoutai,0,0,1,5);
                motor(360,0,0,2,1);
                while(1){
