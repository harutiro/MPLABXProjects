...
# 753 "Q3.c"
    ...
    while(1){
        ...
        if(RA0 == 0 && RA1 == 1){
            dynam((0x02|0x04),(0x02|0x04|0x08|0x10|0x20),0,0);

            tact(0);
            if(((flag_sw3==1)&&(flag_R==1))){
                fclr(2);
                waitSEG((0x02|0x04),(0x02|0x04|0x08|0x10|0x20),1000);
                motor(360,(0x02|0x04),(0x02|0x04|0x08|0x10|0x20),1,5);
                ...
                while(1){
                    ...
                    if(RA0 == 1 && RA1 ==1){
                        dynam((0x02|0x04|0x08|0x10|0x40),(0x02|0x04|0x08|0x10|0x40),0,0);
                        jikan();
                        if(count >= 500){
                            goto hukki;
                        }
        ...
        if(RA0 == 1 && RA1 == 0){
            dynam((0x02|0x04|0x08|0x10|0x20),(0x01|0x02|0x08|0x40|0x10),0,0);

            tact(2);
            if(((flag_sw3==0)&&(flag_P==1))){
                fclr(2);
                waitSEG((0x02|0x04|0x08|0x10|0x20),(0x01|0x02|0x08|0x40|0x10),2000);
                motor(360*2,(0x02|0x04|0x08|0x10|0x20),(0x01|0x02|0x08|0x40|0x10),2,1);
