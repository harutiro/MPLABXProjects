...
# 526 "Q4.c"
    ...
    while(1){
        ...
        if(RA1 == 0){
            ...
            zyoutai = waitSEG(0,(0x08|0x10|0x20),2000);
            if(zyoutai == 1){
                wait(10);
                motor(360,(0x01|0x08|0x10|0x20|0x40),(0x01|0x08|0x10|0x20|0x40),1,1);
                wait(10);
                while(1){
                    dynam((0x01|0x10|0x20|0x40),(0x01|0x10|0x20|0x40),0,0);
                    if(RA0 == 1 && RA1 == 1){
                        goto hukki;
                    }
                }
            }
            zyoutai = motor(90,(0x01|0x02|0x04|0x08|0x10|0x20),(0x20|0x08|0x40|0x01|0x02|0x04),1,5);

            zyoutai = waitSEG((0x02|0x04|0x10|0x20|0x40),0,2000);
            if(zyoutai == 1){
                wait(10);
                motor(270,(0x01|0x08|0x10|0x20|0x40),(0x01|0x08|0x10|0x20|0x40),1,1);
                wait(10);
                while(1){
                    dynam((0x01|0x10|0x20|0x40),(0x01|0x10|0x20|0x40),0,0);
                    if(RA0 == 1 && RA1 == 1){
            ...
            zyoutai = motor(90,(0x02|0x04),(0x01|0x02|0x04|0x08|0x10|0x20|0x40),1,1);

            zyoutai = waitSEG(0,(0x08|0x10|0x20),2000);
            if(zyoutai == 1){
                wait(10);
                motor(180,(0x01|0x08|0x10|0x20|0x40),(0x01|0x08|0x10|0x20|0x40),1,1);
                wait(10);
                while(1){
                    dynam((0x01|0x10|0x20|0x40),(0x01|0x10|0x20|0x40),0,0);
                    if(RA0 == 1 && RA1 == 1){
            ...
            zyoutai = motor(90,(0x01|0x02|0x08|0x40|0x10),(0x01|0x02|0x04|0x20),1,5);

            zyoutai = waitSEG((0x02|0x04|0x10|0x20|0x40),0,2000);
            if(zyoutai == 1){
                wait(10);
                motor(90,(0x01|0x08|0x10|0x20|0x40),(0x01|0x08|0x10|0x20|0x40),1,1);
                wait(10);
                while(1){
                    dynam((0x01|0x10|0x20|0x40),(0x01|0x10|0x20|0x40),0,0);
                    if(RA0 == 1 && RA1 == 1){
            ...
            zyoutai = motor(90,(0x40|0x01|0x08|0x02|0x04),(0x20|0x10|0x08|0x04|0x01|0x40),1,1);
