...
//             zyoutai = waitSEGStop(0,SEGL,2000);
//             if(zyoutai == 1){
//                 wait(100);
//                 motor(360,SEGE,SEGE,T2,H);
//                 wait(100);
//                 while(1){
//                     dynam(SEGF,SEGF,0,0);
//                     if(SW1 == DN && SW2 == DN){
...
//                 }
//             }
//             zyoutai = motor(90,SEG0,SEG9,T2,L);

//             zyoutai = waitSEGStop(SEGH,0,2000);
//             if(zyoutai == 1){
//                 wait(100);
//                 motor(270,SEGE,SEGE,T2,H);
//                 wait(100);
//                 while(1){
//                     dynam(SEGF,SEGF,0,0);
//                     if(SW1 == DN && SW2 == DN){
...
//                 }
//             }
//             zyoutai = motor(90,SEG1,SEG8,T2,H);
 
//             zyoutai = waitSEGStop(0,SEGL,2000);
//             if(zyoutai == 1){
//                 wait(100);
//                 motor(180,SEGE,SEGE,T2,H);
//                 wait(100);
//                 while(1){
//                     dynam(SEGF,SEGF,0,0);
//                     if(SW1 == DN && SW2 == DN){
...
//                 }
//             }
//             zyoutai = motor(90,SEG2,SEG7,T2,L);

//             zyoutai = waitSEGStop(SEGH,0,2000);
//             if(zyoutai == 1){
//                 wait(100);
//                 motor(90,SEGE,SEGE,T2,H);
//                 wait(100);
//                 while(1){
//                     dynam(SEGF,SEGF,0,0);
//                     if(SW1 == DN && SW2 == DN){
...
//                 }
//             }
//             zyoutai = motor(90,SEG3,SEG6,T2,H);
